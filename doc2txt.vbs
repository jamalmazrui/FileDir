...
Dim aSourceFiles
Dim sSourceSpec, sSourceFolder, sWildcards, sSourceFile, sSourceName, sTargetFile, sTargetFormat, sTargetExtension 
Dim iSourceFile, iTargetFormat, iArgCount
...
iArgCount = UBound(WScript.Arguments)
