...
Generated from Hotkeys.ini on 28 August 2026. Do not edit this file; edit Hotkeys.ini and build again.
...
- **Accent** -- Go to Quick Folder: Go to folder of quick links
...
- **Control+2** -- Convert Encoding: Convert character encoding of current or tagged files
...
- **Control+Q** -- Open Quick Folder: Open folder of quick links
...
- **Control+Shift+Tab** -- Previous Window: or Alt+LeftArrow, Activate previous open window
...
- **Control+Tab** -- Next Window: or Alt+RightArrow, Activate next open window
...
- **Shift+2** -- Character Encoding: Detect and say encoding name of current file
...
- **Shift+S** -- Say Size: Say size of current item
