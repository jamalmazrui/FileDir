...
DefaultDirName={pf}\FileDir Scripts
DefaultGroupName=FileDir Scripts
ArchitecturesInstallIn64BitMode=x64 ia64
OutputBaseFilename=FileDir_Scripts_setup
OutputDir=C:\FileDir\scripts
Compression=lzma
...
[Files]
Source: "FileDir.j*"; DestDir: "{code:GetScriptDir}"
Source: "homer.j*"; DestDir: "{code:GetScriptDir}"
Source: "MSAA.j*"; DestDir: "{code:GetScriptDir}"

[Icons]
Name: "{group}\Uninstall FileDir Scripts"; Filename: "{uninstallexe}"
...
[Run]
Filename: "{code:GetSCompilePath}"; Description: "Recompile script file FileDir.jss (recommended)"; Parameters: """FileDir.jss"""; WorkingDir: "{code:GetScriptDir}"; Flags: postinstall
